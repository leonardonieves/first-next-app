            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        ...
                        >
                            <Link href="/note">
                                <Typography sx={{ textDecoration: 'none', color: 'white' }}>Notes</Typography>
                            </Link>
                        </Button>
                        <Button
                            key={'aboutus'}
                        ...
                        >
                            <Link href="/aboutus">
                                <Typography sx={{ textDecoration: 'none', color: 'white' }}>About us</Typography>
                            </Link>
                        </Button>
                        <Button
                            key={'blog'}
                        ...
                        >
                            <Link href="/blog">
                                <Typography sx={{ textDecoration: 'none', color: 'white' }}>Blog</Typography>
                            </Link>
                        </Button>
                    </Box>
